 ...
 */
public class ListpemasukanAdapter extends RecyclerView.Adapter<ListpemasukanAdapter.ViewHolder> {
    private static final String TAG = "ListpemasukanAdapter";
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            icon = (ImageView) v.findViewById(R.id.foto);
        }
     ...
     */
    public ListpemasukanAdapter(String[] dataSet,String[] dataSet2, int[] dataSet3) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_row_pemasukan, viewGroup, false);
